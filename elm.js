...
var _user$project$Model$anotherShoot = A2(
	_evancz$elm_graphics$Collage$move,
	{ctor: '_Tuple2', _0: 0, _1: -200},
	A2(
		_evancz$elm_graphics$Collage$filled,
		_elm_lang$core$Color$red,
		A2(_evancz$elm_graphics$Collage$rect, 2, 30)));
var _user$project$Model$createShoot = A2(
	_evancz$elm_graphics$Collage$filled,
	_elm_lang$core$Color$red,
	A2(_evancz$elm_graphics$Collage$rect, 2, 30));
var _user$project$Model$createPlayer = A2(
	...
	A2(
		...
		A2(
			...
			A2(_evancz$elm_graphics$Collage$ngon, 3, 30))));
var _user$project$Model$createEnemy = A2(
	_evancz$elm_graphics$Collage$rotate,
	_elm_lang$core$Basics$degrees(90),
	A2(
		_evancz$elm_graphics$Collage$move,
		...
		A2(
			...
			A2(_evancz$elm_graphics$Collage$ngon, 4, 30))));
var _user$project$Model$init = {
	player: _user$project$Model$createPlayer,
	pressedKeys: {ctor: '[]'},
	playerPosition: 0,
	shoots: {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: _user$project$Model$anotherShoot,
			_1: {ctor: '_Tuple2', _0: 0, _1: -200}
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: _user$project$Model$createShoot,
	...
	enemies: {
		...
		_0: {
			ctor: '_Tuple2',
			_0: _user$project$Model$createEnemy,
			_1: {ctor: '_Tuple2', _0: 0, _1: 0}
		},
		_1: {ctor: '[]'}
	},
...
var _user$project$Model$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {player: a, pressedKeys: b, playerPosition: c, shoots: d, time: e, enemies: f, randomNumber: g};
	});

var _user$project$Msg$getDirection = function (pressedKeys) {
	return A2(_elm_lang$core$List$member, _ohanhi$keyboard_extra$Keyboard_Extra$CharA, pressedKeys) ? -5 : (A2(_elm_lang$core$List$member, _ohanhi$keyboard_extra$Keyboard_Extra$CharD, pressedKeys) ? 5 : 0);
};
var _user$project$Msg$getSpinning = function (pressedKeys) {
	return A2(_elm_lang$core$List$member, _ohanhi$keyboard_extra$Keyboard_Extra$CharR, pressedKeys) ? true : false;
};
var _user$project$Msg$getShooting = function (pressedKeys) {
	return A2(_elm_lang$core$List$member, _ohanhi$keyboard_extra$Keyboard_Extra$Space, pressedKeys) ? true : false;
};
var _user$project$Msg$changeShootPosition = function (_p0) {
	var _p1 = _p0;
	return {ctor: '_Tuple2', _0: _p1._0, _1: _p1._1 + 25};
};
var _user$project$Msg$separeFormCoord = function (list) {
	var _p2 = _elm_lang$core$List$unzip(list);
	var a = _p2._0;
	var b = _p2._1;
	return b;
};
var _user$project$Msg$separeForm = function (list) {
	var _p3 = _elm_lang$core$List$unzip(list);
	var a = _p3._0;
	var b = _p3._1;
	return a;
};
var _user$project$Msg$zip = F2(
	function (xs, ys) {
		...
		if ((_p4._0.ctor === '::') && (_p4._1.ctor === '::')) {
			return {
				...
				_1: A2(_user$project$Msg$zip, _p4._0._1, _p4._1._1)
			};
		} else {
			return {ctor: '[]'};
		}
	});
var _user$project$Msg$updateEnemyPosition = function (_p5) {
	var _p6 = _p5;
	return {ctor: '_Tuple2', _0: _p6._0, _1: _p6._1 - 5};
};
var _user$project$Msg$updateShootPosition = function (_p7) {
	var _p8 = _p7;
	return {ctor: '_Tuple2', _0: _p8._0, _1: _p8._1 + 25};
};
var _user$project$Msg$filterShoots = function (_p9) {
	var _p10 = _p9;
	return (_elm_lang$core$Native_Utils.cmp(_p10._1._1, 500) > 0) ? false : true;
};
var _user$project$Msg$NewRandom = function (a) {
	return {ctor: 'NewRandom', _0: a};
};
var _user$project$Msg$RollRandom = {ctor: 'RollRandom'};
var _user$project$Msg$ShootTimer = function (a) {
	return {ctor: 'ShootTimer', _0: a};
};
var _user$project$Msg$Spawn = function (a) {
	return {ctor: 'Spawn', _0: a};
};
var _user$project$Msg$DestroyFire = {ctor: 'DestroyFire'};
var _user$project$Msg$SpinToWin = function (a) {
	return {ctor: 'SpinToWin', _0: a};
};
var _user$project$Msg$MoveEnemies = {ctor: 'MoveEnemies'};
var _user$project$Msg$MoveShoots = {ctor: 'MoveShoots'};
var _user$project$Msg$Fire = F2(
	function (a, b) {
		return {ctor: 'Fire', _0: a, _1: b};
	});
var _user$project$Msg$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Msg$UpdatePlayerPosition = function (a) {
	return {ctor: 'UpdatePlayerPosition', _0: a};
};
var _user$project$Msg$MovePlayerHorizontal = function (a) {
	return {ctor: 'MovePlayerHorizontal', _0: a};
};
var _user$project$Msg$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p11 = msg;
			switch (_p11.ctor) {
				case 'RollRandom':
					return {
						...
						_1: A2(
							_elm_lang$core$Random$generate,
							_user$project$Msg$NewRandom,
							A2(_elm_lang$core$Random$int, -220, 220))
					};
				case 'NewRandom':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{randomNumber: _p11._0}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'RotatePlayer':
					var newModel = A2(_evancz$elm_graphics$Collage$rotate, _p11._0, model.player);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
				...
				case 'MovePlayerHorizontal':
					var _p15 = _p11._0;
					var newModel = A2(_evancz$elm_graphics$Collage$moveX, _p15, model.player);
					var _p12 = model.playerPosition;
					switch (_p12) {
						case 220:
							var _p13 = _p15;
							if (_p13 === -5) {
								var _v8 = _user$project$Msg$UpdatePlayerPosition(_p15),
						...
						case -220:
							...
							if (_p14 === -5) {
								...
								var _v11 = _user$project$Msg$UpdatePlayerPosition(_p15),
						...
						default:
							var _v13 = _user$project$Msg$UpdatePlayerPosition(_p15),
				...
				case 'UpdatePlayerPosition':
					var isShooting = _user$project$Msg$getShooting;
					var newModel = model.playerPosition + _p11._0;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							model,
							{playerPosition: newModel}),
						{ctor: '[]'});
				case 'KeyboardMsg':
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								pressedKeys: A2(_ohanhi$keyboard_extra$Keyboard_Extra$update, _p11._0, model.pressedKeys)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Tick':
					var isSpinning = _user$project$Msg$getSpinning(model.pressedKeys);
					var isShooting = _user$project$Msg$getShooting(model.pressedKeys);
					var direction = _user$project$Msg$getDirection(model.pressedKeys);
					return A2(
						_user$project$Msg$andThen,
						_user$project$Msg$SpinToWin(isSpinning),
						A2(
							_user$project$Msg$andThen,
							_user$project$Msg$MoveEnemies,
							A2(
								_user$project$Msg$andThen,
								_user$project$Msg$DestroyFire,
								A2(
									_user$project$Msg$andThen,
									_user$project$Msg$MoveShoots,
									A2(
										_user$project$Msg$update,
										_user$project$Msg$MovePlayerHorizontal(direction),
										_elm_lang$core$Native_Utils.update(
											model,
											{time: _p11._0}))))));
				case 'ShootTimer':
					var isShooting = _user$project$Msg$getShooting(model.pressedKeys);
					var _v15 = A2(_user$project$Msg$Fire, model.playerPosition, isShooting),
					...
					continue update;
				case 'Spawn':
					var newEnemyPosition = {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$toFloat(model.randomNumber),
						_1: 220
					};
					var newEnemy = A2(
						_evancz$elm_graphics$Collage$rotate,
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									...
									enemies: A2(
										...
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: newEnemy, _1: newEnemyPosition},
											_1: {ctor: '[]'}
										})
								}),
							{ctor: '[]'}));
				case 'MoveEnemies':
					var axis = A2(
						_elm_lang$core$List$map,
						_user$project$Msg$updateEnemyPosition,
						_user$project$Msg$separeFormCoord(model.enemies));
					var newEnemies = A2(
						_elm_lang$core$List$map,
						_evancz$elm_graphics$Collage$rotate(
							_elm_lang$core$Basics$degrees(15)),
						A2(
							_elm_lang$core$List$map,
							_evancz$elm_graphics$Collage$moveY(-5),
							_user$project$Msg$separeForm(model.enemies)));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								enemies: A2(_user$project$Msg$zip, newEnemies, axis)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'MoveShoots':
					var axis = A2(
						_elm_lang$core$List$map,
						_user$project$Msg$updateShootPosition,
						_user$project$Msg$separeFormCoord(model.shoots));
					var newShoots = A2(
						_elm_lang$core$List$map,
						_evancz$elm_graphics$Collage$moveY(25),
						_user$project$Msg$separeForm(model.shoots));
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								shoots: A2(_user$project$Msg$zip, newShoots, axis)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Fire':
					var _p16 = _p11._0;
					var newFirePosition = {ctor: '_Tuple2', _0: _p16, _1: -190};
					var newFire = A2(
						_evancz$elm_graphics$Collage$move,
						{ctor: '_Tuple2', _0: _p16, _1: -190},
						A2(
							_evancz$elm_graphics$Collage$filled,
							_elm_lang$core$Color$red,
							A2(_evancz$elm_graphics$Collage$rect, 3, 15)));
					return _p11._1 ? {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
								...
								shoots: A2(
									...
									model.shoots,
									{
										...
										_0: {
											ctor: '_Tuple2',
											_0: newFire,
											_1: {ctor: '_Tuple2', _0: _p16, _1: -190}
										},
										_1: {ctor: '[]'}
									})
							}),
				...
				case 'DestroyFire':
					var getShoot = A2(_elm_lang$core$List$filter, _user$project$Msg$filterShoots, model.shoots);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
...
var _user$project$Msg$andThen = F2(
	function (msg, _p17) {
		var _p18 = _p17;
		var _p19 = A2(_user$project$Msg$update, msg, _p18._0);
...
var _user$project$Msg$KeyboardMsg = function (a) {
	return {ctor: 'KeyboardMsg', _0: a};
};
var _user$project$Msg$RotatePlayer = function (a) {
	return {ctor: 'RotatePlayer', _0: a};
};

var _user$project$Style$styleMainDiv = {
	ctor: '::',
...
var _user$project$Style$styleCanvas = {
	ctor: '::',
...
var _user$project$View$createBackground = _evancz$elm_graphics$Collage$toForm(
	A3(_evancz$elm_graphics$Element$fittedImage, 500, 500, 'https://media.giphy.com/media/ZiDpJRogbB9V6/giphy.gif'));
var _user$project$View$view = function (model) {
	var _p0 = _elm_lang$core$List$unzip(model.enemies);
	var enemies = _p0._0;
	var coordinatesE = _p0._1;
	var _p1 = _elm_lang$core$List$unzip(model.shoots);
	var shoots = _p1._0;
	var coordinates = _p1._1;
	var wasd = _ohanhi$keyboard_extra$Keyboard_Extra$wasd(model.pressedKeys);
	var arrows = _ohanhi$keyboard_extra$Keyboard_Extra$arrows(model.pressedKeys);
	var shiftPressed = A2(_elm_lang$core$List$member, _ohanhi$keyboard_extra$Keyboard_Extra$Shift, model.pressedKeys);
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_user$project$Style$styleMainDiv),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(_user$project$Style$styleCanvas),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _evancz$elm_graphics$Element$toHtml(
						A3(
							...
							{
								ctor: '::',
								_0: _user$project$View$createBackground,
								_1: {
									ctor: '::',
									_0: _evancz$elm_graphics$Collage$group(shoots),
									_1: {
										ctor: '::',
										_0: model.player,
										_1: {
											ctor: '::',
											_0: _evancz$elm_graphics$Collage$group(enemies),
											_1: {ctor: '[]'}
										}
									}
								}
					...
					_1: {
						...
						_0: _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(model.pressedKeys)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$div,
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$src('http://www.kpsearch.com/df/fitness4younew/Darude-Sandstorm.mp3'),
											_1: {
												ctor: '::',
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Msg$KeyboardMsg, _ohanhi$keyboard_extra$Keyboard_Extra$subscriptions),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Time$every, (1000 / 30) * _elm_lang$core$Time$millisecond, _user$project$Msg$Tick),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Time$every, 0.5 * _elm_lang$core$Time$second, _user$project$Msg$Spawn),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$core$Time$every, 200 * _elm_lang$core$Time$millisecond, _user$project$Msg$ShootTimer),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{
		...
		update: _user$project$Msg$update,
